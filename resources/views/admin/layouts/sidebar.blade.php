            ...
            <li class="dropdown {{ setActive(['admin.withdraw-method.*', 'admin.withdraw.index']) }}">
                ...
                <ul class="dropdown-menu">
                    ...
                    <li class="{{ setActive(['admin.withdraw.index']) }}"><a class="nav-link"
                                                                             href="{{ route('admin.withdraw.index') }}">Withdraw
                            List</a></li>
